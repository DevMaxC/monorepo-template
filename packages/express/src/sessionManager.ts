...
export function handleFrontendConnection(ws: WebSocket) {
  console.log('Handling frontend connection');
...
function handleTwilioMessage(data: RawData) {
  console.log('Handling twilio message');
...
function handleFrontendMessage(data: RawData) {
  console.log('Handling frontend message');
  const msg = parseMessage(data);
  if (!msg) return;
...
function tryConnectModel() {
  console.log('Trying to connect model');
...
function handleModelMessage(data: RawData) {
  console.log('Handling model message');
...
function handleTruncation() {
  console.log('Handling truncation');
...
function isOpen(ws?: WebSocket): ws is WebSocket {
  console.log('Checking if connection is open');
